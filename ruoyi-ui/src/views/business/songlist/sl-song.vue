            ...
            <el-col :xs="24" :sm="24" :lg="20">
              <div style="margin-left: 15px;">
                ...
                <div style="margin-top: 15px;">
                  <Img :src="baseUrl+singer.picture" style="width: 30px;height: 30px;border-radius: 25px;"/>
                  <span style="position:relative;top: -12px;font-size: 14px;margin-left: 15px;color: #707070;">{{singer.sinName}}</span>
