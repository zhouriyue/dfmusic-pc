<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="收藏id" prop="colId">
        <el-input
          v-model="queryParams.colId"
          placeholder="请输入收藏id"
          clearable
          size="small"
    ...
    <el-table v-loading="loading" :data="collectionesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收藏id" align="center" prop="colId" />
      <el-table-column label="歌单id" align="center" prop="slId" />
      <el-table-column label="收藏者" align="center" prop="collectBy" />
